...
## Godsend Youtube Tutorials
	...
	[Easy explosion effect](https://www.youtube.com/watch?v=RtJJVjjM_-Q)

## Tools
	#### Godot
	![Godot Engine Logo](/assets/attribution_logos/godot_engine/logo_vertical_color_light.png)  
	...
	#### VSCodium
	![VSCodium Logo](/assets/attribution_logos/vscodium/paulo22s.png)
	Author: [VSCodium team](https://vscodium.com)
	Source: [github: vscodium](https://github.com/VSCodium/vscodium)
	License: [MIT License](https://github.com/VSCodium/vscodium/blob/main/LICENSE)

	#### Git
	![Git Logo](/assets/attribution_logos/git/Git-Logo-2Color.png)
